...
class GenericModelConfig(BaseModel):
    ...
    # API model fields
    api_key: Optional[str] = Field(None, description="API key for API-based models")
...
class GenericDatasetConfig(BaseModel):
    ...
    subset: Optional[str] = Field(None, description="Dataset subset")
    ...
    random_seed: Optional[int] = Field(None, description="Random seed for sampling")
    
    # Custom dataset fields
    custom_path: Optional[str] = Field(None, description="Path to custom dataset")
    custom_format: Optional[str] = Field(None, description="Format of custom dataset")
